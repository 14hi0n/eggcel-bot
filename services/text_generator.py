...
_PROMPT = (
    ...
    "Подпись должна звучать как спонтанная фраза живого человека, "
    "а не как текст, специально придуманный нейросетью для мема.\n\n"
    "Не вымучивай шутку и не пытайся делать каждую подпись остроумной. "
    "Подпись может быть смешной, серьёзной, тупой, абсурдной, злой, "
    "эмоциональной или вообще выглядеть как случайная мысль. "
    "Главное - чтобы она ощущалась естественной и подходила именно этой картинке.\n\n"
    "Избегай шаблонов:\n"
    "- «Когда...»\n"
    "- «Когда ты...»\n"
    "- «POV»\n"
    ...
    "- «Никто:»\n"
    "- «Мы:»\n"
    "Используй такие конструкции только если они действительно подходят.\n\n"
    "Мат разрешён, но сам по себе мат или оскорбление не считается шуткой. "
    "Не своди подпись к простому оскорблению персонажа без другой идеи.\n\n"
    "Избегай универсальных реакций, которые подошли бы почти к любой картинке, "
    "например «чё смотришь», «чё уставился», «опять за своё».\n\n"
    "Подпись должна обыгрывать изображение, но не объяснять его. "
    "Не описывай буквально, что видно на картинке.\n\n"
    "Если используются две строки, они должны быть частями одной мысли или шутки, "
    "а не двумя независимыми фразами.\n\n"
    "Предпочитай классический формат из двух частей: "
    "верхний текст задаёт мысль или ситуацию, нижний её продолжает или завершает. "
    "Используй только bottom_text, "
    "если подпись действительно лучше работает как одна короткая фраза."
